  ...
  <div class="home">
    <div class="blank">
      <div class="rule">
        ...
        <!-- <button @click="koaget">koaget</button> -->
        <!-- <div>注意：你可能处于手机模式，将只能单击操作，双击将会被扣分</div> -->
      </div>
    </div>
    <div class="flex" style="width:100%">
      <div class="sider siderL" style="flex:6">
        <ul>
          ...
          <li v-for="(item,index) in group2.slice(0, 10)" :key="index">
      ...
      <div class="background">
        ...
        <div class="line2">
          ...
          <div id="box1" class="line22 mark" @click="click($event)">
        ...
        <div class="line3">
          <div id="box4" class="line33 mark" @click="click($event)">
            <img class="good" src="../assets/dmz.jpg" style="width:100%;height:100%" alt />
        ...
        <div class="line4">
          <div id="box7" class="line44 mark" @click="click($event)">
            <img class="good" src="../assets/dmz.jpg" style="width:100%;height:100%" alt />
